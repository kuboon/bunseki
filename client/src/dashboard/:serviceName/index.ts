...
(function () {
  async function loadDashboard() {
    try {
      // Parse serviceName from URL
      // URL format: /dashboard/:serviceName/
      ...
      // Render dashboard
      renderDashboard(dashboard, serviceName);
    } catch (error) {
  ...
  function updateBreadcrumb(serviceName: string) {
  ...
  function renderDashboard(
    dashboard: InferResponseType<typeof client.$get, 200>,
    serviceName: string,
  ) {
